...
class Configuration():
    def __init__(self, *args, **kwargs):
        ...
        self.mean_age = kwargs.get('mean_age', 55)
        ...
        #infection variables
        self.infection_range = kwargs.get('infection_range', 0.03) #range surrounding sick patient that infections can take place
